...
class ThreeDMatchTrainVal(data.Dataset):
    def __init__(self, 
        ...
        OVERLAP_RATIO = 0.3 
        DATA_FILES = {
            'train': './GPI-Net-master/misc/split/train_3dmatch.txt',
            'val': './GPI-Net-master/misc/split/val_3dmatch.txt',
...
class ThreeDLOMatchTest(data.Dataset):
    def __init__(self, 
        ...
        with open('./GPI-Net-master/misc/3DLoMatch.pkl', 'rb') as f:
