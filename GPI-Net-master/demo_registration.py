...
def extract_fpfh_features(pcd_path, downsample, device):
    ...
    src_pcd = raw_src_pcd.voxel_down_sample(downsample)
    src_features = o3d.pipelines.registration.compute_fpfh_feature(src_pcd, o3d.geometry.KDTreeSearchParamHybrid(
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pcd1', default='data/cloud_bin_0.ply', type=str)
    parser.add_argument('--pcd2', default='data/cloud_bin_1.ply', type=str)
    ...
    config_path = 'E:/download_browser/GPI-Net-master/snapshot/GPINet_3DMatch_XXX/config.json'
    ...
    miss = model.load_state_dict(
        torch.load(f'E:/download_browser/GPI-Net-master/snapshot/GPINet_3DMatch_XXX/models/model_best.pkl',
