...
dataset = '3DMatch'
experiment_id = f"GPINet_{dataset}_{time.strftime('%m%d%H%M')}"
#print(experiment_id)
...
if dataset == '3DMatch':
    data_arg.add_argument('--root', type=str, default='./datasets/3DMatch')
    ...
    data_arg.add_argument('--root', type=str, default='./datasets/KITTI')
